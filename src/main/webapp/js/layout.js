...
var Layout = function () {
    ...
    console.log("resBreakpointMd = "+resBreakpointMd);
...
//                console.log("set page-content height _1: "+available_height);
            }
        } else {
            if (body.hasClass('page-sidebar-fixed')) {
//            	console.log("body has page-sidebar-fixed");

                height = _calculateFixedSidebarViewportHeight();

//                console.log("_calculateFixedSidebarViewportHeight() = "+height);
...
//            	console.log("body has no page-sidebar-fixed");
                var headerHeight = $('.page-header').outerHeight();
                var footerHeight = $('.page-footer').outerHeight();

//                console.log("App.getViewPort().width = "+App.getViewPort().width);
...
//                    console.log("sidebar height: "+sidebar.height());
                ...
                if ((height + headerHeight + footerHeight) <= App.getViewPort().height) {
                    ...
                    console.log("App.getViewPort().height = "+App.getViewPort().height);
                    console.log("headerHeight = "+headerHeight);
                    console.log("footerHeight = "+footerHeight);
                }
            }
            content.css('min-height', height);
//            console.log("set page-content height _2: "+height);
        }
    };
