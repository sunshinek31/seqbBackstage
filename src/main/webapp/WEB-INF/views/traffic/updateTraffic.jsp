			...
			<div class="portlet-body form" id="txy4">
				<form class="form-horizontal" id="updateTrafficForm" role="form"
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<input type="text" class="form-control" id="uproute"
								name="uproute" value="${trafficVO.route }">
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-offset-3 col-md-5">
						...
						<input type="button" class="btn btn-primary btn-lg green"
							...
							onclick="updatetraffic('${meetingId}','${trafficVO.trafficId }')">
							</div>
					</div>
				</div>
			</form>
...
function updatetraffic(meetingId,trafficId){
	var uproute = $("#uproute").val();
	if(uproute==''){
		alert('请完善信息');
		return;
	}
	$.ajax({
				url : "${ctx}/UIYouyiBackstage/traffic/addOrUpdateTraffic",
				type : "post",
				data : {
					"route":uproute,
					"trafficId":trafficId
