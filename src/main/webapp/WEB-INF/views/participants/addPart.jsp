			...
			<div class="portlet-title" style="position: relative;">
				<div class="caption">
					<i class="icon-settings font-dark"></i> <span
						class="caption-subject font-dark sbold uppercase">添加与会人员</span>
				</div>
			</div>
			<div class="portlet-body form" id="txy4">
				<form class="form-horizontal" id="addPartForm" role="form"
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<input type="text" class="form-control" id="addparticipants"
...
function submit(meetingId){
	var addparticipants = $("#addparticipants").val();
	if(addparticipants==''){
		alert('请完善信息');
		return;
	}
